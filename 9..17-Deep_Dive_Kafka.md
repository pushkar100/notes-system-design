...
In the real world, the "Lanes" (*Partitions*) are *split* across different computers (**Brokers**). This is why *Kafka creates **massive scale**—it uses the CPU and Disk of multiple machines at once*
