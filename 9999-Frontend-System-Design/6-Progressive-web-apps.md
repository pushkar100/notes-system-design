<!-- TOC --><a name="pwas-tutorial-includes-prpl-pattern"></a>
# PWAs Tutorial (Includes PRPL Pattern)

[Source: Udemy](https://www.udemy.com/progressive-web-apps/)

- [PWAs Tutorial (Includes PRPL Pattern)](#pwas-tutorial-includes-prpl-pattern)
   * [Service worker](#service-worker)
      + [Service Worker Lifecycle](#service-worker-lifecycle)
      + [Building a Service Worker](#building-a-service-worker)
      + [Service worker events (`fetch`)](#service-worker-events-fetch)
      + [Scope of a Service Worker](#scope-of-a-service-worker)
      + [`ServiceWorkerRegistration` object](#serviceworkerregistration-object)
      + [Message passing between main context and the service worker](#message-passing-between-main-context-and-the-service-worker)
      + [Push events (notifications)](#push-events-notifications)
   * [Notifications](#notifications)
      + [Server Push and Push Notifications](#server-push-and-push-notifications)
   * [Caching](#caching)
      + [Cache & CacheStorage API](#cache-cachestorage-api)
      + [Caching in the Service Worker](#caching-in-the-service-worker)
      + [Caching strategies for PWAs](#caching-strategies-for-pwas)
   * [Adding Native App Features](#adding-native-app-features)
   * [Bonus Content: How Flipkart Built Their PWA (2016)](#bonus-content-how-flipkart-built-their-pwa-2016)
   * [The PRPL Pattern](#the-prpl-pattern)
      + [Network Latency](#network-latency)
      + [Service Workers](#service-workers)
      + [Bundles & Code-Splitting](#bundles-code-splitting)
      + [Summary](#summary)
- [PRPL (Performance of PWAs)](#prpl-performance-of-pwas)
...
<!-- TOC --><a name="service-worker-lifecycle"></a>
...
<!-- TOC --><a name="building-a-service-worker"></a>
...
<!-- TOC --><a name="service-worker-events-fetch"></a>
...
<!-- TOC --><a name="scope-of-a-service-worker"></a>
...
<!-- TOC --><a name="serviceworkerregistration-object"></a>
...
<!-- TOC --><a name="message-passing-between-main-context-and-the-service-worker"></a>
...
<!-- TOC --><a name="push-events-notifications"></a>
...
<!-- TOC --><a name="server-push-and-push-notifications"></a>
...
<!-- TOC --><a name="cache-cachestorage-api"></a>
...
<!-- TOC --><a name="caching-in-the-service-worker"></a>
...
<!-- TOC --><a name="caching-strategies-for-pwas"></a>
...
<!-- TOC --><a name="adding-native-app-features"></a>
...
<!-- TOC --><a name="bonus-content-how-flipkart-built-their-pwa-2016"></a>
...
<!-- TOC --><a name="bundles-code-splitting"></a>
...
<!-- TOC --><a name="prpl-performance-of-pwas"></a>
