...
<!-- TOC --><a name="levels-of-abstraction"></a>
...
<!-- TOC --><a name="advantages-of-distributed-services"></a>
...
<!-- TOC --><a name="software-architecture-position-in-the-sdlc"></a>
...
<!-- TOC --><a name="challenges-of-software-architecture"></a>
...
<!-- TOC --><a name="gathering-requirements"></a>
...
<!-- TOC --><a name="importance-of-gathering-requirements"></a>
...
<!-- TOC --><a name="types-of-requirements"></a>
...
<!-- TOC --><a name="limitations-and-boundaries"></a>
...
<!-- TOC --><a name="right-way-to-gather-functional-requirements"></a>
...
<!-- TOC --><a name="formal-way-of-gathering-requirements"></a>
...
<!-- TOC --><a name="steps-to-gather-requirements"></a>
...
<!-- TOC --><a name="more-on-non-functional-requirements"></a>
...
<!-- TOC --><a name="non-functional-requirements-need-to-be-proven"></a>
...
<!-- TOC --><a name="last-consideration-is-feasibility"></a>
...
<!-- TOC --><a name="system-constraints"></a>
### System constraints 
...
<!-- TOC --><a name="legalregulatory-constraints"></a>
...
<!-- TOC --><a name="accepting-vs-pushing-back-on-constraints"></a>
...
<!-- TOC --><a name="measuring-response-time-distribution"></a>
...
<!-- TOC --><a name="tail-latency-in-response-times"></a>
...
<!-- TOC --><a name="identifying-performance-degradation"></a>
...
<!-- TOC --><a name="understanding-load"></a>
### Understanding load
...
<!-- TOC --><a name="intuition-for-a-scalable-design"></a>
...
<!-- TOC --><a name="note-on-linear-scalability"></a>
...
<!-- TOC --><a name="types-of-scalability"></a>
...
<!-- TOC --><a name="vertical-scalability"></a>
...
<!-- TOC --><a name="horizontal-scalability"></a>
...
<!-- TOC --><a name="pros-and-cons-of-each-scalability-choice"></a>
...
<!-- TOC --><a name="team-organisational-scalability"></a>
...
<!-- TOC --><a name="formula-of-availability"></a>
...
<!-- TOC --><a name="alternative-formula-of-availability"></a>
...
<!-- TOC --><a name="myth-of-complete-availability"></a>
...
<!-- TOC --><a name="the-9s-of-availability"></a>
...
<!-- TOC --><a name="failure-prevention"></a>
#### Failure prevention
...
<!-- TOC --><a name="types-of-redundancy"></a>
#### Types of redundancy
...
<!-- TOC --><a name="strategies-for-redundancy"></a>
...
<!-- TOC --><a name="failure-detection"></a>
#### Failure detection
...
<!-- TOC --><a name="slas-slos-and-slis"></a>
### SLAs SLOs and SLIs

<!-- TOC --><a name="sla-or-service-level-agreement"></a>
...
<!-- TOC --><a name="slos-or-service-level-objectives"></a>
...
<!-- TOC --><a name="slis-or-service-level-indicators"></a>
...
<!-- TOC --><a name="important-considerations"></a>
...
<!-- TOC --><a name="categories-of-apis"></a>
### Categories of APIs
...
<!-- TOC --><a name="api-best-practices"></a>
### API best practices
...
<!-- TOC --><a name="remote-procedure-calls"></a>
...
<!-- TOC --><a name="rest-api-quality-attributes-non-functional-requirements"></a>
...
<!-- TOC --><a name="rest-api-endpoints"></a>
#### REST API endpoints
...
<!-- TOC --><a name="best-practices-for-resources"></a>
...
<!-- TOC --><a name="crud-operations-via-http-verbs"></a>
...
<!-- TOC --><a name="rest-api-step-by-step-process"></a>
...
<!-- TOC --><a name="why-is-grpc-popular"></a>
### Why is gRPC popular?
...
<!-- TOC --><a name="architectural-blocks-of-large-scale-systems"></a>
...
<!-- TOC --><a name="benefit-of-using-a-load-balancer"></a>
...
<!-- TOC --><a name="quality-attributes-of-a-load-balancer"></a>
...
<!-- TOC --><a name="types-of-load-balancers"></a>
...
<!-- TOC --><a name="dns-load-balancer"></a>
#### DNS load balancer
...
<!-- TOC --><a name="hardware-and-software-load-balancers"></a>
...
<!-- TOC --><a name="global-server-load-balancing"></a>
...
<!-- TOC --><a name="common-load-balancer-tools"></a>
...
<!-- TOC --><a name="quality-attributes-of-message-brokers"></a>
...
<!-- TOC --><a name="popular-message-broker-tools"></a>
...
<!-- TOC --><a name="popular-api-gateways"></a>
...
<!-- TOC --><a name="api-gateway-vs-load-balancer"></a>
...
<!-- TOC --><a name="content-delivery-networks"></a>
...
<!-- TOC --><a name="popular-cdn-providers"></a>
